...
# train the model
model <- train(Attrition~., data=numdf, method="lvq", preProcess=c("BoxCox", "scale","center"), search="grid", trControl=control, metric = "Kappa")
...
# Logistic Regression
```{r}
lfit <- glm(relevel(Attrition, ref="No")~., family=binomial(), data=num_df)
summary(lfit)
...
# Combine all models
```{r}
pred_df$logistic <- as.factor(ltest$predict)

pred_df$pred_E[pred_df$pred_A=="No" & pred_df$pred_K=="No" & pred_df$logistic=="No"] <- "No"
pred_df$pred_E[pred_df$pred_A=="Yes" & pred_df$pred_K=="Yes" & pred_df$logistic=="Yes"] <- "Yes"
pred_df$pred_E[pred_df$pred_A=="No" & pred_df$pred_K=="Yes" & pred_df$logistic=="Yes"] <- "Yes"
pred_df$pred_E[pred_df$pred_A=="No" & pred_df$pred_K=="No" & pred_df$logistic=="Yes"] <- "No"
pred_df$pred_E[pred_df$pred_A=="No" & pred_df$pred_K=="Yes" & pred_df$logistic=="No"] <- "No"
pred_df$pred_E[pred_df$pred_A=="Yes" & pred_df$pred_K=="No" & pred_df$logistic=="No"] <- "No"
pred_df$pred_E[pred_df$pred_A=="Yes" & pred_df$pred_K=="No" & pred_df$logistic=="Yes"] <- "Yes"
pred_df$pred_E[pred_df$pred_A=="Yes" & pred_df$pred_K=="Yes" & pred_df$logistic=="No"] <- "Yes"
